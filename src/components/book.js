import { Box, Column, Row, Text, Image, Pressable } from "native-base";

export default function Book({ onPress,  book: { title, isbn13, num_pages, price, author: authors, book_language: {language_name}}}) {
